...
namespace Engine {
    ...
    void VulkanImage::Free()
    {
        ...
        // Prevent double-free if called again.
    ...
    void VulkanImage::Allocate()
    {
        ...
        ENGINE_ASSERT_MSG(vma && vma->IsInitialized(), "VulkanImage: VMA subsystem not initialized");
        ...
        mAllocation = vma->AllocateImage(spec);
        ENGINE_ASSERT_MSG(mAllocation.IsValid(), "VulkanImage: image allocation failed");
    }
